(function (global, factory) {
        ...
        value: function sendPayload(payload) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            request.addEventListener('error', function () {
              _this.connected = false;
              reject(new Error("Network error ".concat(JSON.stringify(payload))));
            });
            try {
    ...
    function (_AbstractSocketProvid) {
      ...
      _createClass(MetamaskProvider, [{
        ...
        value: function sendPayload(payload) {
          var _this2 = this;
          var method = Array.isArray(payload) ? 'sendAsync' : 'send';
          return new Promise(function (resolve, reject) {
            _this2.connection[method](payload, function (error, response) {
              if (!error) {
                return resolve(response);
              }
              reject(error);
